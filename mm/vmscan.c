...
// static int page_comp_by_uid(void *priv, const struct list_head *a, const struct list_head *b)
// {
// 	struct page *page_a = container_of(a, struct page, lru);
// 	struct page *page_b = container_of(b, struct page, lru);
// 	if(page_app_id(page_a) < page_app_id(page_b))
// 		return -1;
// 	else if(page_app_id(page_a) > page_app_id(page_b))
// 		return 1;
// 	else
// 		return 0;
// }

// static int page_comp_by_pfn(void *priv, const struct list_head *a, const struct list_head *b)
// {
// 	struct page *page_a = container_of(a, struct page, lru);
// 	struct page *page_b = container_of(b, struct page, lru);
// 	unsigned long pfn_a = page_to_pfn(page_a);
// 	unsigned long pfn_b = page_to_pfn(page_b);
// 	if(page_app_id(page_a) == page_app_id(page_b)) {
// 		if(pfn_a < pfn_b)
// 			return -1;
// 		else if(pfn_a > pfn_b)
				     ...
				     bool ignore_references)
{
	...
	/**
	 * reorder the pages in page_list based on page->uid
	 */
	// print_page_list(page_list);
	// list_sort(NULL, page_list, page_comp_by_uid);
	// list_sort(NULL, page_list, page_comp_by_pfn);
	// print_page_list(page_list);
